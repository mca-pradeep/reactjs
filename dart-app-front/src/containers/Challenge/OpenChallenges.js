...
export class OpenChallenges extends Component {
            ...
            <div className="p-grid">
                <div className="p-col-12">
                    <div className="card card-w-title">
                        <h1>Open Challenges of the Week</h1>
...
const mapStateToProps = state => {
  return {
    ...
    dataTableValue: state.openChallengeReducer.openChallengesList
    //store:
  };
};
...
const mapDispatchToProps = dispatch => {
  return {
    onRequestPageLoad: () => dispatch(actions.challenges())
  };
};
